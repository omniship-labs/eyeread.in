...
/**
 * Overlay settings — rendered inside .ov-drawer which handles show/hide.
 * Always fully opaque so controls are readable regardless of panel opacity setting.
 */
export function SettingsDrawer({ settings, onPatch }) {
  return (
    <div className="ov-drawer-content">
