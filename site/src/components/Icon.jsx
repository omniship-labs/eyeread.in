/* One <Icon name="..." /> entry point so config stays framework-agnostic
   (it just names icons as strings). Generic icons come from lucide-react;
   brand marks (GitHub, Apple) are inline since lucide dropped brand icons. */
import {
  EyeOff,
  Mic,
  Aperture,
...
export function Icon({ name, size = 24 }) {
  ...
  if (name === 'apple') return <AppleIcon size={size} />;
