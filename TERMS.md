...
**eyeread.in does not record audio or video.** The microphone, if you grant
permission, is used solely for on-device voice tracking to follow your place in
the script. Audio is processed entirely on your device by the operating system's
speech recognition engine and is never captured, stored, or transmitted by the App.

**You are solely responsible for how you use the App.** This includes, without
limitation:

- Ensuring that any recording, broadcast, or screen-share session conducted by
  third-party software (such as Zoom, OBS, or QuickTime) while you use the App
  complies with all applicable laws, including consent and wiretapping laws in
  your jurisdiction and the jurisdictions of any other participants.
- Obtaining any required consents from other parties before recording or
...
- Record or monitor any person without their legally required consent
- Infringe the intellectual property rights of any third party
- Distribute malware or engage in any activity that interferes with the App or
  its infrastructure
...
without regard to its conflict-of-law principles. Any dispute arising out of
these Terms or the App shall be resolved exclusively in the state or federal
courts located in Delaware, and you consent to personal jurisdiction there.

Nothing in these Terms limits any rights you may have under the mandatory
