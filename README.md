...
Invisibility is OS-guaranteed on macOS and Windows, but real-world confirmation
...
**On a setup that's still untested, or a distro/version not listed?** Run the
quick check and report back via a
...
Wayland *and* X11). Confirmed reports are added to the matrix with credit.
